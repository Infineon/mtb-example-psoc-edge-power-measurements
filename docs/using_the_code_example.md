...
The following example clones the "[Power measurements](https://github.com/Infineon/mtb-example-psoc-edge-power-measurements)" application with the desired name "PowerMeasurements" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-power-measurements --user-app-name PowerMeasurements --target-dir "C:/mtb_projects"
   ```
